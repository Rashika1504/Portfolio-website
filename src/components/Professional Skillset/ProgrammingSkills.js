...
import { CPP, MongoDB, ReactJS, NodeJs, JavaScript} from "../asset/svg/svg";
import { useSelector } from "react-redux";
const skills = [CPP, ReactJS, JavaScript, NodeJs, MongoDB];
const skillNames=["C++","ReactJs","JavaScript","NodeJs","MongoDB"];
